...
-- -- 2. Clients
-- INSERT INTO clients (id, vendor_id, name, contact_person, contact_email, contact_phone, industry, address, status) VALUES
-- (1, 1, 'Apex Financial Services', 'Robert Sterling', 'r.sterling@apexfinancial.com', '+1 (555) 234-5678', 'Financial Services', '100 Wall Street, New York, NY', 'ACTIVE'),
-- (2, 1, 'Logistics Global Inc.', 'Claire Vance', 'claire@logisticsglobal.com', '+1 (555) 876-5432', 'Supply Chain & Logistics', '450 Harbor Blvd, Long Beach, CA', 'ACTIVE'),
-- (3, 1, 'BioCare Health Network', 'Dr. Arthur Harris', 'aharris@biocarehealth.org', '+1 (555) 345-6789', 'Healthcare & Biotech', '720 Health Park Way, Boston, MA', 'ACTIVE'),
-- (4, 2, 'Nexus Retail Systems', 'Sophia Lin', 'sophia@nexusretail.com', '+1 (555) 987-6543', 'Retail & E-commerce', '33 Market Square, Seattle, WA', 'ACTIVE');
...
-- 3. Users — payout_currency, tax_region, tax_exempt added
-- Passwords: staff = password123 | client = client
INSERT INTO users (id, vendor_id, client_id, name, email, password, role, status, skills, availability, weekly_capacity_hours, payout_currency, tax_region, tax_exempt) VALUES
(1,  1, NULL, 'Eleanor Vance',  'eleanor.vance@vendorcorp.com',  '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'VENDOR_ADMIN',    'ACTIVE',      'Workforce Planning, Vendor Management, Executive Billing',   'FULL_TIME',  40, 'USD', 'US-DEFAULT', FALSE),
(2,  1, NULL, 'Sarah Jenkins',  'sarah.j@vendorcorp.com',        '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'PROJECT_MANAGER', 'ACTIVE',      'Agile Delivery, Cloud Architecture, Scrum',                 'FULL_TIME',  40, 'USD', 'US-DEFAULT', FALSE),
(3,  1, NULL, 'David Miller',   'david.m@vendorcorp.com',        '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'PROJECT_MANAGER', 'ACTIVE',      'ERP Implementation, Financial Tech, Technical Lead',          'FULL_TIME',  40, 'USD', 'US-DEFAULT', FALSE),
(4,  1, NULL, 'Alex Rivera',    'alex.rivera@contractor.io',     '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'React, Next.js, Tailwind CSS, Node.js',                      'FULL_TIME',  40, 'USD', 'US-DEFAULT', FALSE),
(5,  1, NULL, 'Marcus Chen',    'marcus.chen@contractor.io',     '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'PostgreSQL, Database Tuning, Go, Backend API',                'FULL_TIME',  40, 'USD', 'US-TX',     FALSE),
(6,  1, NULL, 'Elena Rostova',  'elena.rostova@contractor.io',   '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'UI/UX Design, Figma, Design Systems, Frontend',              'PART_TIME',  20, 'EUR', 'EU-VAT',    FALSE),
(7,  1, NULL, 'Devon Smith',    'devon.smith@contractor.io',     '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'DevOps, Kubernetes, AWS, Terraform',                         'FULL_TIME',  40, 'USD', 'US-CA',     FALSE),
(8,  1, NULL, 'Priya Patel',    'priya.patel@contractor.io',     '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'QA Automation, Cypress, Jest, Integration Testing',          'FULL_TIME',  40, 'INR', 'IN-GST',    FALSE),
(9,  1, NULL, 'Jordan Lee',     'jordan.lee@contractor.io',      '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'Python, Data Analytics, ETL, Snowflake',                     'FULL_TIME',  40, 'INR', 'IN-GST',    TRUE),
(10, 1, NULL, 'Sam Taylor',     'sam.taylor@contractor.io',      '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'UNAVAILABLE', 'iOS, Swift, Mobile Security',                                'UNAVAILABLE',  0, 'USD', 'US-DEFAULT', FALSE),
(11, 1, NULL, 'Taylor Reed',    'taylor.reed@contractor.io',     '$2b$10$Drrm/mF5exDz6/Yg7IiCLOE5DuQ2e.gcnH/EVx7vGvIbMCRulE4Rm', 'EMPLOYEE',        'ACTIVE',      'Fullstack JavaScript, GraphQL, Micro-frontends',             'FULL_TIME',  40, 'GBP', 'UK-VAT',    FALSE),
(12, 1, 1,    'Apex Financial',  'client@client.com',             '$2b$10$.O/fW8bu7/nPtn1jJP9hpOcVIWh5yOne674cZ.I6HmuzUuOwR4WaW',  'CLIENT',          'ACTIVE',      'Project Commissioning',                                      'FULL_TIME',  40, 'USD', 'US-DEFAULT', FALSE);

SELECT setval('users_id_seq', 12, true);

-- 4. Projects — billing_currency added (all USD for now)
INSERT INTO projects (id, vendor_id, client_id, name, client_name, description, budget, start_date, end_date, status, project_manager_id, billing_currency) VALUES
(1, 1, 1, 'Apex Fintech Modernization', 'Apex Financial Services', 'Full overhaul of core trading portal and client dashboard with modern web stack.', 250000.00, '2026-06-01', '2026-12-31', 'ACTIVE', 2, 'USD'),
(2, 1, 2, 'Cloud Migration & Data Pipeline', 'Logistics Global Inc.', 'Migrating legacy ERP workloads to AWS cloud with automated Snowflake ETL pipelines.', 180000.00, '2026-07-15', '2026-11-30', 'ACTIVE', 3, 'USD'),
(3, 1, 3, 'Healthcare AI Analytics Portal', 'BioCare Health Network', 'HIPAA compliant portal for patient telemetry and automated diagnostic reporting.', 140000.00, '2026-08-01', '2026-10-31', 'PENDING', 2, 'USD');
...
-- 9. Invoices & Items
INSERT INTO invoices (id, project_id, invoice_number, invoice_date, subtotal, tax, total, status) VALUES
(1, 1, 'INV-2026-001', '2026-08-15', 28400.00, 5112.00, 33512.00, 'SENT'),
(2, 2, 'INV-2026-002', '2026-08-16', 35000.00, 6300.00, 41300.00, 'SENT');
...
-- 11. Contractor Payrolls — with multi-currency fields
INSERT INTO contractor_payrolls (id, milestone_id, project_id, employee_id, assignment_id, total_hours, billing_rate, gross_pay, payout_currency, exchange_rate_used, gross_pay_local, tax_rate_applied, tax_amount_local, net_pay_local, status) VALUES
(1, 1, 1, 4, 1, 40.00, 85.00, 3400.00, 'USD', 1.000000, 3400.00, 0.0000, 0.00, 3400.00, 'PROCESSED'),
(2, 1, 1, 5, 2, 40.00, 95.00, 3800.00, 'USD', 1.000000, 3800.00, 0.0625, 237.50, 3562.50, 'PROCESSED');
